...
>
> GitHub的markdown语法在标准的markdown语法基础上做了扩充，称之为`GitHub Flavored Markdown`。简称`GFM`，GFM在GitHub上有广泛应用，README文件、issues和wiki均支持markdown语法。
...
```
https://github.com/ice-melt/picset/raw/master/Logo/foryou.gif
```
